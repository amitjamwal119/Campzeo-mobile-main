...
// export const generateAIMessageApi = async (prompt: string, platform: string) => {
//   const response = await axios.post(
//     "https://api.openai.com/v1/chat/completions",
//     {
//       model: "gpt-4",
//       messages: [{ role: "user", content: `Generate a short social media post for platform ${platform} about "${prompt}".` }],
//       max_tokens: 150,
//     },
//     {
//       headers: {
//         Authorization: `Bearer ${process.env.OPENAI_API_KEY}`, // use server key here
