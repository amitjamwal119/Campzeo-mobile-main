          ...
          { text: "Cancel", style: "cancel" },
          {
            ...
            onPress: async () => {
              try {
                ...
                console.log("Delete Notification API Error:", error.response?.data || error);
                Alert.alert(
                  "Error",
      ...
      <ThemedView className="flex-1 px-4 pt-4">
        ...
        <View className="flex-row items-center justify-between mb-3">
          <View className="flex-row space-x-2">
            ...
            >
              <Text
                style={{ fontWeight: tab === "All" ? "bold" : "normal", color: tab === "All" ? "#fff" : "#374151" }}
              >
            ...
            >
              <Text
                style={{ fontWeight: tab === "Unread" ? "bold" : "normal", color: tab === "Unread" ? "#fff" : "#374151" }}
              >
                Unread ({unreadCount})
              </Text>
            </TouchableOpacity>
          ...
          <TouchableOpacity onPress={markAllAsRead}>
            <Text style={{ color: "#dc2626", fontWeight: "bold" }}>Mark all as read</Text>
          </TouchableOpacity>
        </View>
        ...
        {!loading && !hasNotifications && (
          <View className="flex-1 items-center justify-center mt-10">
            ...
            <Text style={{ color: "#6b7280", marginTop: 12 }}>Looks like there’s nothing here</Text>
          </View>
        )}
        ...
        {!loading && hasNotifications && (
          <SectionList
            ...
            renderSectionHeader={({ section }) => (
              <Text style={{ fontWeight: "bold", color: "#6b7280", marginTop: 16, marginBottom: 4 }}>
                {section.title}
              </Text>
            )}
            renderItem={({ item }) => (
