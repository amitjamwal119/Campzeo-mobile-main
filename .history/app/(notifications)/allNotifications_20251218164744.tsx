      ...
      <ThemedView className="flex-1 px-4 pt-4">
        ...
        <View className="flex-row items-center justify-between mb-3">
          <View className="flex-row space-x-2">
            <TouchableOpacity
              onPress={() => setTab("All")}
              className={`px-4 py-1 rounded-full ${tab === "All" ? "bg-[]" : "bg-white"}`}
            >
            ...
            <TouchableOpacity
              ...
              className={`px-4 py-1 rounded-full ${tab === "Unread" ? "bg-[]" : "bg-white"}`}
            >
          ...
          <TouchableOpacity onPress={markAllAsRead}>
            <Text className="text-[] font-medium">Mark all as read</Text>
          </TouchableOpacity>
        </View>
            ...
            renderItem={({ item }) => (
              ...
              >
                <View className="flex-row justify-between items-start">
                  ...
                  {!item.read && <View className="w-3 h-3 bg-[] rounded-full mt-1" />}
                </View>
              </TouchableOpacity>
            )}
          />
