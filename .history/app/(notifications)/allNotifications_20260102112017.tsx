...
import { getNotificationsApi, deleteNotificationApi } from "@/api/notification/notificationApi";
...
export default function AllNotifications() {
  ...
  // ---------------- FILTERS ----------------
  const filteredAll = tab === "All" ? notifications : notifications.filter((n) => !n.read);
