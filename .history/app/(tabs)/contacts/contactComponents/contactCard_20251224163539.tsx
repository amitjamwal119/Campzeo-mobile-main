            ...
            <View className="flex-row flex-wrap">
              {record.campaigns && record.campaigns.length > 0 ? (
                record.campaigns.map((c) => (
                  <View
                    key={c.id}
                    className="bg-gray-100 px-2 py-0.5 rounded-full ml-2"
                  >
                    <Text className="text-gray-800 text-base">{c.name}</Text>
                  </View>
                ))
              ) : (
                <Text className="text-gray-500 text-base ml-2">No campaigns</Text>
              )}
            </View>
          </View>
        </View>
