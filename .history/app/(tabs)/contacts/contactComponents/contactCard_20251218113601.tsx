...
{record.show && (
  <View className="mt-3 space-y-2">
    {[
      ...
      <View key={index} className="flex-row justify-between items-center px-3 py-2 rounded-lg">
        <LinearGradient
        ...
        >
          <Text className="text-xs text-white font-semibold">{item.label}</Text>
        </LinearGradient>
        <Text className="text-sm text-gray-800">{item.value}</Text>
      </View>
    ))}
  </View>
)}
