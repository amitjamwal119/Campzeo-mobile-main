...
export default function ContactCard({
  ...
  <View className="mt-3 space-y-2">
    {[
      { label: "Email", value: record.email, icon: "mail-outline", color: "#3b82f6" }, // Tailwind blue-500
      { label: "Mobile", value: record.mobile, icon: "call-outline", color: "#6b7280" }, // Tailwind gray-500
      { label: "WhatsApp", value: record.whatsapp, icon: "logo-whatsapp", color: "#22c55e" }, // Tailwind green-500
    ].map((item, index) => (
