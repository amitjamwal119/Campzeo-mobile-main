    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: "row" }}>
          ...
          <TouchableOpacity onPress={() => onToggleShow(record)} className="mx-1">
            <Ionicons
      ...
      {record.show && (
        <View className="mt-2.5">
          ...
          <View className="flex-row justify-between mb-1">
            <Text className="font-bold text-gray-900">Mobile</Text>
            <Text className="text-gray-700">{record.mobile}</Text>
          </View>

          <View className="flex-row justify-between mb-1">
            <Text className="font-bold text-gray-900">WhatsApp</Text>
            <Text className="text-gray-700">{record.whatsapp}</Text>
          </View>
        </View>
      )}
