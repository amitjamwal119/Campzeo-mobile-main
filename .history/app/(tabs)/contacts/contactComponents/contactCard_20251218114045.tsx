    ...
    >
      ...
      {record.show && (
        <View className="mt-3 space-y-2">
          {[
            { label: "Email", value: record.email, icon: "mail-outline", color: "#3b82f6" }, // blue
      { label: "Mobile", value: record.mobile, icon: "call-outline", color: "#6b7280" }, // gray
      { label: "WhatsApp", value: record.whatsapp, icon: "logo-whatsapp", color: "#22c55e" }, // green
    ].map((item, index) => (
