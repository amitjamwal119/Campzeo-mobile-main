  ...
  <View className="mt-3 space-y-2">
    ...
    <View className="flex-row justify-between items-center">
      <View className="px-2 py-0.5 bg-gray-100 rounded-full">
        <Text className="text-xs text-gray-700">Mobile</Text>
      </View>
    ...
    <View className="flex-row justify-between items-center">
      <View className="px-2 py-0.5 bg-green-100 rounded-full">
        <Text className="text-xs text-green-700">WhatsApp</Text>
      </View>
      <Text className="text-sm text-gray-800">{record.whatsapp}</Text>
    </View>
  </View>
)}
