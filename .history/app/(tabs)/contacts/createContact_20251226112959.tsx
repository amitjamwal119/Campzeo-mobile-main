import {
  createContactApi,
  updateContactApi,
  getContactsApi, // <-- make sure you have this API
...
export default function CreateContact() {
  ...
  useEffect(() => {
    ...
    reset({
      ...
      selectedContacts: editingContact.selectedContacts ?? [],
    });
  ...
  useEffect(() => {
    const fetchContacts = async () => {
      ...
      try {
        ...
        const data = await getContactsApi(token); // fetch all contacts
        const options =
    ...
    >
      ...
      >
        ...
        <View className="space-y-6">
          ...
          <FormControl>
            <FormControl.Label>
              <Text className="text-base mt-6 font-semibold text-gray-700">
                Select Contacts
              </Text>
            </FormControl.Label>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        ...
                        if (checked) {
                          ...
                          setValue("selectedContacts", [...current, contact.id]);
                        }
                      }}
                      className="flex-row items-center my-2"
                    >
