...
export default function Contacts() {
  ...
  const handleShare = async () => {
    ...
    const message =
      ...
      records
        .map(
          (r) => `${r.name}\t${r.email}\t${r.mobile}\t${r.whatsapp}`
        )
        .join("\n");
  ...
  return (
    <View className="flex-1 p-4 bg-gray-100">
      ...
      <View className="flex-row items-center mb-4">
        <TouchableOpacity
          onPress={handleNew}
          className="flex-row items-center px-3 py-2 rounded-xl bg-blue-100 mr-2"
        >
          <Ionicons
        ...
        ListFooterComponent={
          filteredRecords.length > 5 ? (
            <TouchableOpacity
              ...
              className={`py-3 my-2 rounded-full items-center ${
