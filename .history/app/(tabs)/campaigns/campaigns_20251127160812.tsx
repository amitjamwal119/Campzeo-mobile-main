...
export default function Campaigns() {
  ...
  const [campaigns, setCampaigns] = useState<Campaign[]>([
    {
      ...
      posts: ["Initial post", "Promo image"],
      show: true,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      posts: ["Promo post 1", "Promo post 2"],
      show: true,
    },
    {
      id: 4,
      ...
      posts: ["Winter discounts", "New arrivals"],
      show: true,
    },
    {
      id: 5,
    ...
    },
    {
      ...
      posts: ["Huge Black Friday deals", "Limited stock"],
      show: true,
    },
  ]);
  ...
  // Handlers
  const handleEdit = (c: Campaign) => console.log("Edit:", c);
  ...
  const handleCopy = (c: Campaign) => {
    const newCampaign = {
      ...
      posts: [...c.posts],
      description: c.description, // ✅ copy description too
    };
  ...
  const handleShare = async () => {
    ...
    const message =
      header + campaigns.map((c) => `${c.details}\t${c.dates}\t${c.description}`).join("\n");
    try {
