...
// Map type to icon component and color
        ...
        {tempPosts.length === 0 ? (
          ...
          <>
            ...
            <View className="flex-row justify-between mt-4">
              ...
              >
                <Text style={{ color: currentPage === 1 ? "#9CA3AF" : "#fff", fontWeight: "600" }}>
                  Previous
                </Text>
              </TouchableOpacity>
              ...
              >
                <Text style={{ color: currentPage === totalPages ? "#9CA3AF" : "#fff", fontWeight: "600" }}>
                  Next
                </Text>
              </TouchableOpacity>
            </View>
