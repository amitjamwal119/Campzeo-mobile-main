...
export default function CampaignsDetails() {
  ...
  // State to hold posts
  const [posts, setPosts] = useState(tempPostsData);
  ...
  // Edit post → navigate to campaignPost.tsx
  ...
  // Delete post → show alert + remove from state
  ...
  const renderPostItem = ({ item }: { item: any }) => {
    ...
    return (
      <View className="bg-white p-4 rounded-xl mb-4 shadow relative">
        ...
        {/* Schedule time in next line */}
        <Text className="font-semibold text-black">Schedule</Text>
