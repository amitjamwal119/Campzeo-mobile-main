...
import CampaignCard, { Campaign, Post } from "./campaign-components/campaignCard";
...
export default function Campaigns() {
  ...
  // Initialize campaigns, each with its own empty posts array
  ...
  const handleCopy = (c: Campaign) => {
    const newCampaign: Campaign = {
      ...
      posts: [] as Post[], // empty posts for new copy
