        ...
        <View className="flex-1  bg-gray-100">
          ...
          {showWhatsAppContent && (
            <RNView className="flex-row mb-3">
              <Button
                onPress={handleAIGenerateMessage}
                style={{ flex: 1, backgroundColor: "#3b82f6", borderRadius: , marginRight: 8 }}
              >
              ...
              <Button
                ...
                style={{ flex: 1, backgroundColor: "#16a34a", borderRadius:  }}
              >
                <Text style={{ color: "#fff", fontWeight: "bold", textAlign: "center" }}>
                  Generate Image
                </Text>
          ...
          {showFileButton && (
            <Button
              ...
              style={{ backgroundColor: "#aaaaaa", borderRadius:  }}
            >
              <Text style={{ color: "#fff", fontWeight: "bold", textAlign: "center" }}>
                Choose File
              </Text>
