...
<TextInput
  ...
  className="border border-gray-300 rounded-lg px-3 h-12 mb-4 bg-white"
/>
...
{showWhatsAppContent && (
  <>
    ...
    <View className="flex-row items-center mb-4">
      <TextInput
        placeholder="handleAIGenerateMessage"
      ...
      />
      <TouchableOpacity
        onPress={handleAIGenerateMessage} // optional AI button for subtitle
        style={{
    ...
    <View className="flex-row items-center mb-4">
      ...
      />
      <TouchableOpacity
        onPress={handleAIGenerateMessage} // optional AI button for tags
        style={{
          backgroundColor: "#3b82f6",
          height: 43,
          paddingHorizontal: 16,
      ...
      >
        <RNView>
          ...
          <Button
            ...
            style={{ backgroundColor: "#d55b35", borderRadius: 50 }}
          >
            <Text style={{ color: "#fff", fontWeight: "bold", textAlign: "center" }}>
