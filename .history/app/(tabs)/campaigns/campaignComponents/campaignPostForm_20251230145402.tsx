...
export default function CampaignPostForm({
  ...
  // ================= ADDITION: GENERATE TEXT HANDLER =================
  const handleGenerateText = () => {
    ...
    // Temporary logic – replace with AI API later
    setMessage(
      `This is an auto-generated message based on the subject:\n\n"${subject}"`
    );
  };
  // ================================================================
    ...
    >
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="flex-1 bg-gray-100 p-4">
          ...
          {/* ================= ADDITION: GENERATE TEXT BUTTON ================= */}
          <TouchableOpacity
            onPress={handleGenerateText}
            className="self-start bg-blue-600 px-4 py-2 rounded-full mb-4"
          >
            <Text className="text-white font-bold">Generate Text</Text>
          </TouchableOpacity>
          {/* ================================================================ */}
