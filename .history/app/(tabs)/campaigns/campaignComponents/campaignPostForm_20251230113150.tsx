...
const handleAddAttachment = async () => {
  ...
  if (result.type === "success") {
    // result is already typed as DocumentPickerSuccessResult
    setAttachments((prev) => [
      ...prev,
      {
        uri: result.uri,
        name: result.name,
        type: getMimeType(result.name), // infer mime type from file extension
      },
    ]);
  }
};

// Helper function to infer MIME type (basic version)
