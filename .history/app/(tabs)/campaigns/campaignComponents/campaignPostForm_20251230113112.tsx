...
const handleAddAttachment = async () => {
  ...
  if (result.type === "success") {
    const file = result as DocumentPicker.DocumentPickerSuccessResult;

    setAttachments((prev) => [
      ...prev,
      {
        uri: file.uri,             // exists on success result
        name: file.name,           // exists on success result
        type: (file as any).mimeType || "application/octet-stream", // cast to any to suppress TS error
      },
    ]);
  }
};
