...
const [destinationLink, setDestinationLink] = useState<string>("");
  ...
  <View style={{ marginTop: 16, padding: 12, borderWidth: 1, borderColor: "#d1d5db", borderRadius: 8 }}>
    ...
    <Text style={{ fontWeight: "bold", marginBottom: 4 }}>Select Board</Text>
    <TouchableOpacity
      ...
      style={{
        ...
        borderWidth: 1,
        borderColor: pinterestBoard ? "#2563eb" : "#d1d5db",
        borderRadius: 8,
        backgroundColor: "#fff",
        marginBottom: 8,
      }}
    >
      <Text style={{ color: pinterestBoard ? "#000" : "#6b7280" }}>
    ...
    {isCreatingPinterestBoard && (
      <TouchableOpacity
        onPress={() => console.log("Create new board pressed")}
        style={{
          paddingVertical: 8,
          borderWidth: 1,
          borderColor: "#d1d5db",
    ...
    {/* Destination Link */}
    <Text style={{ fontWeight: "bold", marginBottom: 4 }}>Destination Link (Optional)</Text>
    <TextInput
