  ...
  const handleOpenAIContent = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        mode: "generate-multiple", // request multiple suggestions
        count: 10, // ✅ request up to 10 suggestions (adjust as needed)
      };
      ...
      // save all suggestions and open modal
          ...
          <Modal visible={modalVisible} animationType="slide" transparent>
            <View className="flex-1 justify-center bg-black/40 p-4">
              <View
                ...
                style={{ maxHeight: "60%" }} // fixed height, scrollable
              >
