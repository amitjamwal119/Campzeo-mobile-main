...
const [message, setMessage] = useState<string | null>("");  const [postDate, setPostDate] = useState<Date | null>(null);
  ...
  const handleAIGenerateImage = async () => {
    ...
    try {
      setLoadingAI(true);
      const token = await getToken();
      const imageUrl = (await generateAIImageApi(subject, platform, token)) ?? null;
