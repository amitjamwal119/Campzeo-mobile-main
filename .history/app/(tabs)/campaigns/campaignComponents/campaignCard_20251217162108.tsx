    ...
    <View className="bg-white p-4 rounded-xl mb-4 shadow">
      ...
      {isExpanded && (
        <View>
          ...
          <Text className="text-gray-700 mb-3">{campaign.description ?? "Untitled Campaign"}</Text>

          <Text className="font-bold text-gray-900 mb-1">Dates</Text>
          <Text className="text-gray-700 mb-3">{campaign.dates ?? "Untitled Campaign"}</Text>
...
<text> every milestone we celebrate is powered by feedback from you. we posted weekly updates, highlighted real-use scenarios, and collaboarated with cstomers to imporve what we offer. The best</text>