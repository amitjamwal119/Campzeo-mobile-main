...
export default function CampaignCard({
  ...
  const getStatus = () => {
    ...
    const endDateStr = campaign.dates.split("-")[1]?.trim();
  ...
  const contactsCount =
    campaign.contactsCount ?? campaign.contacts?.length ?? 0;
                ...
                {showPostButton && !postButtonTopRight && (
                  ...
                  >
                    <Ionicons
                      ...
                      color="#3b82f6"
                    />
                    <Text className="ml-1.5 text-[16px] text-blue-500 font-semibold">
                      Post
                    </Text>
                  </TouchableOpacity>
                )}
