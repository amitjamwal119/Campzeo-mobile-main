      ...
      {isExpanded && (
        <View>
          ...
          <View className="mb-3">
            ...
            {/* Row 1: Contacts + Posts on left, Status on right */}
<View className="flex-row items-center justify-between mt-3 w-full">
  ...
  <View className="flex-row items-center">
    ...
    <Ionicons name="albums-outline" size={18} color="#4b5563" className="ml-4" />
    <Text className="ml-1.5 text-gray-700 text-base">
