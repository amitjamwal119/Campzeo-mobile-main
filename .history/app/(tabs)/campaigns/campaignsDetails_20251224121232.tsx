...
const handleEditPost = (campaignId: number, post: any) => {
  ...
  <TouchableOpacity
    ...
    hitSlop={{ top: 12, bottom: 12, left: 12, right: 12 }} // increase tappable area
    activeOpacity={0.6}
  >
  ...
  <TouchableOpacity
    ...
    hitSlop={{ top: 12, bottom: 12, left: 12, right: 12 }} // 🔥 add hitSlop here
    activeOpacity={0.6} // optional: adds press feedback
  >
