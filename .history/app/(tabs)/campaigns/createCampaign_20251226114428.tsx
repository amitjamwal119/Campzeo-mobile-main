...
import { createCampaignApi, updateCampaignApi, getCampaignByIdApi,} from "@/api/campaign/campaignApi";
    ...
    >
      ...
      >
        ...
        <View className="space-y-6">
          ...
          {/* Select Contacts */}
          <FormControl>
            <FormControl.Label>{requiredLabel("Select Contacts")}</FormControl.Label>
            <FlatList
              data={contacts}
              ...
              renderItem={({ item }) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    className="flex-row items-center py-2 px-3 border border-gray-200 rounded-xl mb-2"
                    style={{ backgroundColor: selected ? "#dbeafe" : "#fff" }}
                  >
                    <Ionicons
